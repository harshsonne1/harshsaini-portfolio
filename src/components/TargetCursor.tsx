...
// TargetCursor (React Bits) — custom spinning reticle cursor that snaps its
// corner brackets to `.cursor-target` elements. Ported to TS; the .css lives in
// globals.css (.target-cursor-* rules, including mix-blend-mode: difference).
