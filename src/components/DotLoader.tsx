...
// DotLoader — a 7x7 dot matrix that plays a list of frames, each frame being
// the indices of the dots lit in it. Lit dots carry the `active` class, so the
// look is entirely the caller's (`dotClassName`).
//
// One change from the original: the interval ref is typed nullable, which
// React 19's types require. Sizing is the shipped default — 6px dots on a
// 2px gap, 54px of matrix.
