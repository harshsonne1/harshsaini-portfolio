...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    if (!node) return;
    // hoisted render() below loses the null-narrowing on both of these, so
    // hold the checked values in their own bindings
    ...
    if (!context) return;
    // hoisted render() below loses the null-narrowing, so hold the checked
    // context in its own binding
